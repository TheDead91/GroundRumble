...
// External dev server: HTTPS (self-signed). Binds to all interfaces so any
// non-localhost access (network IPs, *.nord hostnames) is served over HTTPS.
export default defineConfig({
  server: {
    host: '0.0.0.0',
    https: {},
  },
  plugins: [securityHeaders(), basicSsl(), react()],
  build: {
